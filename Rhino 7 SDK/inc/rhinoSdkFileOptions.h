...
public:
  ...
  */
  ...
  Returns:
    ...
    >0: Serial number of an instance definition
        based on the contents of the file being read.
        When an instance defintion is being created, the
  ...
  */
  ...
  Returns:
    ...
    2: reference
       Put the idef
  Remarks:
    When a linked instance defintion is being read in an
  ...
  */
  ...
  Parameters:
    ...
    reference_component_name - [out]
      both paramters can be the same string.
  Example:
 ...
 public:
  ...
  enum class ModeFlag : unsigned int
  {
    ...
    // and when instance defintion name collisions occur, the existing
...
private:
  class CRhinoFileReadOptions_Impl* m_impl = nullptr;
};
