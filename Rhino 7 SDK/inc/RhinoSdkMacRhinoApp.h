...
#include "../../RhCommandAutocompleter.h"
...
public:
  ...
  BOOL RhinoWriteProfileString(const wchar_t*, const wchar_t*, const char*, int);
  BOOL RhinoWriteProfileString(const wchar_t*, const wchar_t*, const wchar_t*, int);
  BOOL RhinoWriteProfileString(const wchar_t*, const wchar_t*, CString&, int);
  ...
  //
  // Returns:
  //   Refererence to the requested document.
...
protected:
  ...
  BOOL m_bInitialized;       // TRUE after initialization is completed
