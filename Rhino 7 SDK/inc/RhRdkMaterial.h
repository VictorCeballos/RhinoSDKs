...
#define RDK_MAT_TRANSPARENT  L"transparent" // Used by simulation instead of RDK_MAT_TRANSPARENCY_COLOR
...
public:
	...
	virtual const ON_Material& SimulatedMaterial(CRhRdkTexture::TextureGeneration tg=CRhRdkTexture::TextureGeneration::Allow, int iSimulatedTextureSize = -1, const CRhinoObject* pObject=nullptr) const;
...
protected:
	...
	/** Implement this method to modify an ON_Material to simulate this material as best you can.
		Callers should call SimulatedMaterial() instead which is optimized to only do the
