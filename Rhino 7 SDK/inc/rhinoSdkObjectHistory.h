...
private:
  ...
  //      can be modifed without breaking the SDK as long as existing
...
public:
  /*
  Description:
    Called by Trim and Split when using replace object is not feasable.
  */
...
/*
	...
	Description:
		...
		single instance of the command execution.  When command execution terminates the inital setting
