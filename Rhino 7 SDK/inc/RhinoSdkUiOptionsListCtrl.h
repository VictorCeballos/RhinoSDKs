...
public:
  ...
  //
  // Returns:
  //   Returns true if the items hide state was succesfully changed or false if not.
  //
  ...
  //   iBottom [in] Space bellow last visible item in list
  //
  // See Also:
  ...
  //     r.bottom = Space bellow last visible item in list
  //
  // See Also:
  //   CRhinoUiOptionsListCtrl::Borders()
  //   
  ...
  //     CRect.bottom = Space bellow last visible item in list
  //   
  // See Also:
  ...
  enum options_list_ctrl_styles
  {
    ...
    no_row_highlight                     =     8, // off by default, if this is set then rows will always paint the same, no hightlight background on labels or vales.
  ...
  //   
  // Description:
  //   Call this method to enabel or disable item label indenting.
  //
  // Parameters:
...
private:
  ...
  // Parameters:
  //   point [in] Current mouse postion to start tracking from.  This becomes
  //     the anchor for the resize event.  The new width is based on the
  //     difference of current mouse postion X and the anchor point X.
  // See Also:
  ...
  // Parameters:
  //   point [in] Current mouse postion
  // See Also:
  ...
  // Description:
  //   This method is called when the left mouse button is released durring a label column resize event.  It will
  ...
  //   mode [in] This parameter identifies the traking method calling this metod.  If this method is called
  ...
  //             durring drag the old line must be removed and the new one drawn.
  //
  // See Also:
