...
/** \class CRhRdkContentCtrl
	...
	Provides a control that supports adding and deleting content
	by using a context menu and/or a button, or drag and drop.

*/
class RHRDK_SDK CRhRdkContentCtrl : public CRhRdkContentCtrlBase
{
public:
	CRhRdkContentCtrl();
...
class RHRDK_SDK CRhRdkMaterialCtrl : public CRhRdkContentCtrl
{
public:
	CRhRdkMaterialCtrl();
...
class RHRDK_SDK CRhRdkEnvironmentCtrl : public CRhRdkContentCtrl
{
public:
	CRhRdkEnvironmentCtrl();
...
class RHRDK_SDK CRhRdkTextureCtrl : public CRhRdkContentCtrl
{
public:
	CRhRdkTextureCtrl();
