...
public:
  ...
  BOOL operator>(const CRhinoSnapEvent&) const;
  BOOL operator<(const CRhinoSnapEvent&) const;
  BOOL operator==(const CRhinoSnapEvent&) const;
  BOOL operator!=(const CRhinoSnapEvent&) const;
...
public:
  ...
  // The type of inferred curve. 0=notset 1=ortho, 2=tan 4=perp, 8=tan_parallel 16=perp_parallel, 32=guide
  // can be a combination of the types
  int m_type; 
...
public:
  ...
  */
  ...
  // true if eligable events should be added to the intersection
  // snap list.
