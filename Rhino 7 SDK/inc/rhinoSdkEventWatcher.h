...
/*
Description:
  This class is a virtual base class that defines
  the interface for watching events in Rhino.  If
  you want to watch one or more events, derive a
  class from CRhinoEventWatcher and override the
  virtual functions that correspond to the events
  you want to watch.

  You will only be notified if your event watcher
  is registered and enabled.  You must explicitly
  register your event watcher by calling Register()
  and then enable your event watcher by calling
  Enable(true).
*/
...
public:
  ...
  */
  virtual
  void OnEnableEventWatcher( BOOL b );
  ...
  */
  ...
  // Description:
  //   Called when the active document chagnes.
  // Paramters:
  ...
  */
  ...
  Remarks:
    "86" is restuarant slang for "nix"
...
public:
  ...
  enum event_type
  {
    ...
    // Rhino is idel, call RhinoApp().TargetDocRuntimeSerialNumber()
  ...
  /*
    Call this function to register your watcher.
    Your watcher will not be called until it is
    registered.
  */
  bool Register();
...
public:
  ...
  public:
    ...
    // This id of the display that is either changing or has been changed to (see below).
...
public:
  ...
  public:
    ...
    //    these values to the CRinoPlugIn::Settings() values to see if anyting you
    //    care about changed.
