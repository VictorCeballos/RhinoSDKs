...
public:
  ...
  Parameters:
    doc [in] - document containg dimension style table
    set_current [in] - Style index of item to set as current
  Returns:
    Number of styles added to list
  */
  int LoadStyles( CRhinoDoc* doc, BOOL show_referenced = true, int set_current = -1);
  /*
  Description:
  ...
  */
  BOOL RemoveStyleFromList( int style_index);
  /*
  Description:
