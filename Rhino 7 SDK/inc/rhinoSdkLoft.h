...
public:
  ...
  BOOL UseStartPoint() const;
  BOOL UseEndPoint() const;

  BOOL MatchStartTangent() const;
  void SetMatchStartTangent( BOOL match = TRUE);

  BOOL MatchEndTangent() const;
  void SetMatchEndTangent( BOOL match = TRUE);
  ...
  BOOL m_bUseStartpoint;
  BOOL m_bUseEndpoint;
  BOOL m_bAllowStartTangent; // set if the start curve is an edge
  BOOL m_bAllowEndTangent;   // set if the end curve is an edge
