...
/**	\class IRhRdkColorPicker
	...
	This interface allows you to provide a customized color picker to use with CRhRdkColorButton.
	The implementation of this interface is not the picker window itself, but it instead creates and
	manages the picker window.
*/
class RHRDK_SDK IRhRdkColorPicker
{
public:
