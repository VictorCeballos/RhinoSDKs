...
public:
  ...
  void SetFlat( BOOL);
  void SetPitchMode( BOOL);
  void SetHelixMode( BOOL);
  void SetReverseTwist( BOOL);
  void SetVertical( BOOL);
  void SetAroundCurve( BOOL);
  void SetToleranceWarning( BOOL);
  ...
  const BOOL PitchMode() const;
  const BOOL HelixMode() const;
  const BOOL ReverseTwist() const;
  const BOOL Vertical() const;
  const BOOL AroundCurve() const;
  const BOOL ToleranceWarning() const;
  const BOOL DiameterMode() const;
...
Parameters:
  ...
  points_per_turn - [in] Number of points to intepolate per turn. Vlaue must be
...
Remarks:
  ...
  bewteen turn will be set to pitch.  Use positive turn_count/pitch for
