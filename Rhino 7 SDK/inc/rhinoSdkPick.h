...
public:
  ...
  // is a page view, then you need to distingish between the viewports
  ...
  */
  ...
  Parameters:
    ...
    hit_tex_st - [out] if not NULL and the mesh has texture coordinates, 
          ...
          point.  Note that the texture coodinates can be set
  ...
  */
  ...
  Parameters:
    ...
    clip_points - [in]
      ...
      calculate the clip_pionts[] and clip_flags[] informaton once per point 
  ...
  Remarks:
    The value of CRhinoPickContext.m_pick_mode is ignored. The hit point caluculation
  ...
  */
  ...
  Returns:
    ...
    If bReturnSubObjects is false and the pick sytle is a window or crossing,
  ...
  */
  ...
  Parameters:
    subd_frit - [in]  
      A subd mesh fragment interator.
      The value of subd_frit.SubDAppearance() determines if the surface
      or control net is inspected.
...
public:
  ...
  */
  ...
  //
  //
  // If all four of the m_bExclude* values are true, every possiblity is excluded 
...
private:
  ...
  // possiblity is excluded and nothing from a proxy brep is eligible for selection.
  //
