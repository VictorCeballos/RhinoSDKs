...
public:
	...
	*/
	...
	public:
		Light(const ON_Light&, CRhinoEventWatcher::light_event);
		virtual ~Light(void);
...
protected:
	...
	virtual void PostLightChange(const UUID& id, CRhinoEventWatcher::light_event ev, const ON_Light& light);
	...
	/*virtual*/ void PostDisplayAttributesChange(const CDisplayPipelineAttributes& da);
	...
	/*virtual*/ void PostMeshInstanceAdded(const CInstanceAncestry& uuidHistory, const ON__UINT32& materialId, const ON_Xform& instanceXForm, const ON_Xform& ocsXform, bool bCastShadows, bool bReceiveShadows, CRhRdkDecalIterator*);
