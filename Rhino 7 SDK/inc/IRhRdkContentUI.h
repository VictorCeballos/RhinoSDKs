...
/** \class CRhRdkCustomContentUI
	...
	CRhRdkCoreContent::CreateUI() to create your own custom UI, you must derive your UI
	...
	Please do not try to directly implement IRhRdkContentUI.
