...
public:
  ...
  //       BOOL cull(const CRhinoUiDockBar* arg,void* p).
  ...
  //
  // Parameters:
  //   uuid [in] ID for dock bar to check visiblity state.
  //
  // Returns:
  ...
  //
  // Parameters:
  //   index [in] Index of dock bar to check visiblity state.
  //
  // Returns:
  //   Returns true if dock bar is currently visible or false if it is not.
  //
  ...
  //
  // Parameters:
  //   dock_bar [in] Dock bar to check visiblity state.
  //
  // Returns:
  //   Returns true if dock bar is currently visible or false if it is not.
  //
  ...
  //   frame window.  Your derived class defintion must include the DECLARE_SERIAL
  //   macro and the implimentation file must include DECLARE_SERIAL.
  //
  // For example:
  //    MyDockBar.h file
  ...
  //
  // Returns:
  //   Pointer to dock bar if succesfully allocated.
  //
  // Note:
  ...
  //   will save current dock and tool bar postions and states.
  //
  // Returns:
  ...
  //
  // Parameters:
  //   b [in] If true then dock bars and views will not be hidden oterwise they will.
  //
  ...
  //
  // Description:
  //   Called one time durring initialization when it is time to create default
  //   dock and tool bars.
  //
  // Returns:
  ...
  //   Call this method if you want to unhook, destory and delete a control bar at runtime.
  //
  // Parameters:
  ...
  //   notification.
  //
  void CallOnActivateApp( BOOL bActive, DWORD dwThreadID);
private:
  ///////////////////////////////////////////////////////////////////////////////////
  //
  // FOR INTERNAL USE ONLY
  ...
  //
  // Returns:
  //   0 Based index to dock bar if succesfully added.
  //   -1 If pCB is NULL.
...
private:
  ...
  // Frame which owns Rhino contol bars
