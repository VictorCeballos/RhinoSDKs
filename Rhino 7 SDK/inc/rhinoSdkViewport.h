...
public:
  ...
  */
  bool SetVP( const ON_Viewport&, BOOL bUpdateTargetLocation, BOOL bAddToViewStack = true );
  ...
  */
  void SetTarget(
         ...
         BOOL bUpdateCameraLocation = true
         );
  ...
  */
  void SetTargetAndCameraLocation(
         ...
         BOOL bUpdateCameraDirection = true,
         BOOL bAddToViewStack = true
         );
  ...
  */
  ...
  int Iteration()    const { return m_vp_iteration;  }
...
public:
  ...
  */
  bool UpdateTransforms( BOOL bForceUpdate = false );
...
public:
  ...
  void DrawWireframeMesh(const ON_Mesh*, BOOL bCullCW);
  ...
  ON_DEPRECATED_MSG("use CRhinoDisplayPipeline::DrawShadedMesh")
  void DrawRenderPreviewMesh(const ON_Mesh*, const CRhinoMaterial& render_material, BOOL bCullCW, BOOL bHighlighted);
  ON_DEPRECATED_MSG("use CRhinoDisplayPipeline::DrawShadedMesh")
...
class RHINO_SDK_CLASS CRhinoViewportIterator
{
  ...
  Example:
    ...
    unsinged int rhino_doc_sn = 0 or CRhinoDoc.RuntimeSerialNumber();
    unsinged int rhino_view_sn = 0 or CRhinoView.RuntimeSerialNumber();
