...
public:
  ...
  */
  ...
  /*
    ...
    See Also:
      See MFC help for class COleDropTarget for description
  */
  virtual BOOL OnDrop(CWnd* pWnd, COleDataObject* pDataObject, DROPEFFECT dropEffect, const ON_2iPoint& point);
  /*
    Description:
  ...
  */
  ...
  /*
    ...
    Parameters:
      ...
      pRhinoView  [in] View the drop action occured in
      pDataObject [in] Points to the data object that contains the data to be dropped.
      ...
      point       [in] Contains the current location of the cursor in client coordinates.
    Returns:
      Returns true if data object was succesfully dropped on the specified object      
    See Also:
  ...
  */
  ...
  /*
    ...
    Parameters:
      ...
      point       [in] Contains the current location of the cursor in client coordinates.
    Returns:
      Returns true if data object was succesfully dropped.
    See Also:
  ...
  */
  ...
  /*
    Description:
      Called by the frame work at the very begining and end of a drag event.
  */
  ...
  */
  ...
  /*
    Description:
      ...
      it will not get called by the frame work durring drop events.
    Parameters:
  ...
  */
  ...
  /*
  Description:
    Point to the layer list control if the drag cursor is currently over it.
  Returns:
    Valid point if over the layer list control otherwise NULL.
  */
  HWND RhinoLayerListCtrlFromDragPoint( HWND pWnd, const ON_2iPoint& point, ON_2iPoint* ptList) const;
  /*
  Description:
    Check to see if mouse is currently over an the Rhino
    layer list control.
  Returns:
    When the mouse is over the Rhino layer list control a pointer to it is
    returned.  If not over the control then NULL is returned.
  See Also:
    CRhinoDropTarget::EnableAllowDropOnRhinoLayerListControl
  */
  ...
  /*
  Description:
    Return layer index of item the drag cursor is currently over.
  Returns:
    Valid layer index if over a layer item in the Rhino layer dialog otherwise
    returns -1.
  See Also:
    CRhinoDropTarget::EnableAllowDropOnRhinoLayerListControl
    CRhinoDropTarget::RhinoLayerListCtrl
  */
