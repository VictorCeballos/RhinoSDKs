...
public:
  ...
  //Remarks:
  // No support for any boundary other than rectangles in V4
  ...
  //   coordiates with depth from near (z=1) to far (z= -1).
  // Parameters:
...
private:
  void DrawNestedViewport(CRhinoDisplayPipeline& parent_pipe, bool bActiveViewport) const;
  ...
  // The viewport member varable is maintained as a pointer in order to maintain
