...
#define RDK_SUN_MIN_YEAR 1980 // Minimum allowed year for sun methods.
#define RDK_SUN_MAX_YEAR 2180 // Maximum allowed year for sun methods.

#define RDK_SUN_MIN_TIME  315525600 // 1st January 1980.
#define RDK_SUN_MAX_TIME 6658495200 // 31st December 2180.

/** \class IRhRdkSunRO

	This is the interface to a read-only sun.

*/
class RHRDK_SDK IRhRdkSunRO
{
public:
	...
	/** Retrieves the local date and time of the observer.
		...
		\return The local date and time of the observer. */
	...
	/** Retrieves the date and time of the observer as Coordinated Universal Time (UTC).
		...
		\param iDayOut accepts the day in the range 1 to 31.
		\param dHoursOut accepts the time expressed as decimal hours in the range 0 to 24.
		\return The UTC date and time of the observer. */
	...
	/** return the shadow intensity to be used for the sun.  This is 1.0 by default.  0.0 turns off all shadows. */
...
/** \class IRhRdkSun
	...
	This is the interface to a read-write sun.
...
*/
class RHRDK_SDK IRhRdkSun : public IRhRdkSunRO
{
public:
	virtual ~IRhRdkSun() { }
	...
	/*virtual*/ void SetIntensity(double dIntensity);
