...
public:
  ...
  void DrawBezier(int dim, BOOL bIsRational, int order, int cv_stride, const double*  cv4d, const CRhCurveAttributes& attrs) override;
...
private:
  bool DrawTexturedPlane(const CRhinoDib& image, const ON_2dPoint& screenLowerLeft, const ON_2dPoint& screenLowerRight, const ON_2dPoint& screenUpperRight, const ON_2dPoint& screenUpperLeft, const ON_NurbsCurve* boundary) const;
