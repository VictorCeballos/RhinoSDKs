...
public:
  ...
  static int CheckSemiModalMessagePump();
	...
	// Modeless construct
	BOOL Create(LPCTSTR lpszTemplateName, CWnd* pParentWnd = nullptr) override;
...
protected:
  ...
  virtual BOOL OnCommand(WPARAM wParam, LPARAM lParam);// override; //not an override on OSX
...
public:
  ...
  BOOL UpdateData(BOOL toVars=TRUE);
