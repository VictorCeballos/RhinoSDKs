...
public:
	...
	virtual const CRhRdkTexture* Texture(CRhRdkMaterial::ChildSlotUsage type) const;
	virtual void SetTexture(CRhRdkMaterial::ChildSlotUsage type, const CRhRdkTexture* pTexture);

	virtual bool    Filtered(CRhRdkMaterial::ChildSlotUsage type) const;
	virtual void SetFiltered(CRhRdkMaterial::ChildSlotUsage type, bool b);

	virtual double  Amount(CRhRdkMaterial::ChildSlotUsage type) const;
	virtual void SetAmount(CRhRdkMaterial::ChildSlotUsage type, double d);
