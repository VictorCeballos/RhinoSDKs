...
OVERVIEW TEXT
  ...
  and undo.  You never directoy

KEYWORDS
  get_object, get_point, get_sphere, get_cylinder
-------------------------------------------------------------------*/
class RHINO_SDK_CLASS CRhinoGet
{
  // base class for all Rhino SDK CRhinoGet* classes
public:
  /*
  Description:
  ...
  */
  ...
  enum result 
  {
    ...
    winmsg,   // Windows posted a message id that was in the list passed
              ...
              // to get the message.
    timeout,  // The getter waited for the amount of time specifed
    ...
    exit_rhino = 0x0FFFFFFF // stop now, do not cleaup, just return ASAP.
  };
  ...
  Description:
    ...
    description unless you explicity enable AcceptNothing.
  Parameters:
  ...
  See Also:
    CRhinoGet::SetDefaultPoint
    CRhinoGet::SetDefaultString
    CRhinoGet::SetDefaultNumber
    CRhinoGet::ClearDefault
    CRhinoGet::AcceptNothing
    CRhinoGet::SetCommandPrompt
  */
  void SetCommandPromptDefault( 
  ...
  See Also:
    ...
    CRhinoGet::SetDefaultNumber
    CRhinoGet::ClearDefault
    CRhinoGet::SetCommandPromptDefault
    CRhinoGet::AcceptNothing
  */
  void SetDefaultPoint( 
    ON_3dPoint default_point 
    );
  ...
  See Also:
    RhinoFormatNumber
    CRhinoGet::SetDefaultInteger
    CRhinoGet::SetDefaultPoint
    CRhinoGet::SetDefaultString
    CRhinoGet::SetDefaultNumber
    CRhinoGet::SetDefaultColor
    CRhinoGet::ClearDefault
    CRhinoGet::SetCommandPromptDefault
    CRhinoGet::AcceptNothing
  */
...
*/
  ...
  */
  ...
  /*
  Description:
    Clears any defalts se using SetDefaultPoint, SetDefaultNumber,
  ...
  */
  ...
  See Also:
    CRhinoGet::AddCommandOptionInteger
    CRhinoGet::AddCommandOptionNumber
    CRhinoGet::AddCommandOptionString
    CRhinoGet::AddCommandOptionColor
    CRhinoGet::AddCommandOptionToggle
  ...
  */
  ...
  void AcceptUndo(BOOL b = true);    // call to allow user undo previous selection.
...
protected:
  ...
  BOOL m_bAcceptUndo;
  BOOL m_bAcceptPoint; // 3d world point
...
public:
  ...
  void AcceptEnterWhenDone(BOOL b = true);
...
private:
  ...
  BOOL m_bGotDefaultValue;

protected:
  void SetOptionAccelerators();

private:
  BOOL IsValidOptionFirstChar( wchar_t ) const;
  int m_option_index;
