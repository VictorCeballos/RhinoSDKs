...
#error rhinoSdkStdafxPreamble.h MUST be included in your plug-in's stdafx.h file BEFORE any other includes.
#endif
...
#if !defined(_AFXDLL)
#error Rhino and Rhino plug-ins must dyanamically link MFC.
#endif
#endif
