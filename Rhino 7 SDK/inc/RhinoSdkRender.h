...
public:
  ...
  // Description:
  //   Called br ProcessGeometryTable() when an obect is encountered that does 
  //   not contain a render mesh.
  // Returns:
  //   TRUE  - object wont be rendered
  //   FALSE - If plug-in will render this object
  virtual BOOL IgnoreRhinoObject( const CRhinoObject* object);
  // Description:
  //   Called br ProcessGeometryTable() when an obect is encountered that contains
  //   a render mesh.
  // Returns:
  //   TRUE  - If plug-in will render this object
  //   FALSE - object wont be rendered
  ...
  /*
  Description:
    Called by Render or RenderWindow() when a key press or mouse down event occurs durring rendering.  To interupt
  ...
  */
  ...
  /*
  Description:
    Called by Render() and RenderWindow() durring modal processing.  Modal loop will continue
...
public:
  // Description:
  //   Called br ProcessGeometryTableEx() when an obect is encountered that does 
  //   not contain a render mesh.
  // Returns:
  //   TRUE  - object wont be rendered
  //   FALSE - If plug-in will render this object
  ...
  // Description:
  //   Called br ProcessGeometryTableEx() when an obect is encountered that contains
  //   a render mesh.
  // Returns:
  //   TRUE  - If plug-in will render this object
  //   FALSE - object wont be rendered
