...
public:
  ...
  */
  ...
  /*
   Description:
   Given a file path, check for existance of the file's containing directory.
   Parameters:
   lpsFileName [in] - File path to validate.
   Returns:
   TRUE if directory exists.
   */
  static BOOL DirExistsForFile( const wchar_t* lpsFileName);
  ...
  */
  ...
  /*
    ...
    Returns:
      TRUE if successfull.
  */
  static BOOL MakeUniqueFilename( ON_wString& result);
  /*
    Description:
    ...
    Returns:
      TRUE on success.
  */
  static BOOL BackupExistingFile( const wchar_t* filename, ON_wString& tempname);
  /*
    Description:
    ...
    Returns:
  */
  static BOOL RestoreBackupFile( const wchar_t* filename, const wchar_t* tempname);
  ...
  */
  static BOOL GetWindowsSpecialFolderPath( int nFolder, ON_wString& result );
  ...
  /*
    ...
    Returns:
      If Rhino could figure out the path then TRUE is returned otherwise FALSE is.
  */
  static BOOL GetMyDocumentsFolder( ON_wString& result);
  ...
  /*
    ...
    Returns:
      If Rhino could figure out the path then TRUE is returned otherwise FALSE is.
  */
  static BOOL GetRhinoApplicationDataFolder( ON_wString& result);
  ...
  */
  ...
  /*
    Description:
      ...
      enough to figure out if it nees to add the '\' between directory and file name.
    Parameters:
  ...
  */
  static BOOL MakeFullPath( ON_wString& result, const wchar_t* lpsDirectory, const wchar_t* lpsFileName, const wchar_t* lpsExtension = 0);
  ...
  */
  static CRhinoCommand::result GetDirectory( ON_wString& wDir, BOOL bShowDialog = TRUE, HWND hWndParent = NULL);
  /*
    Description:
  ...
  */
  ...
  /*
    ...
    Parameters:
      ...
      wResult [out]              - Reference to ON_wString which will recieve the computed relative path
    Returns:
      Returns true if paramaters are valid and lpsFrom is indeed relative to lpsRelativeTo otherwise returns false
  */
  ...
  /*
    ...
    Parameters:
      ...
      wResult [out]                - Reference to ON_wString which will recieve the computed absolute path
    Returns:
      Returns true if paramaters are valid and lpsRelativePath is indeed relative to lpsRelativeTo otherwise returns false
  */
