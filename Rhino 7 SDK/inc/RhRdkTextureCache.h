...
public:
	...
	/*virtual*/ ON_wString Filename(Location locationFileIsExpected) const;
	...
	/*virtual*/ bool HasCachedTexture(Location locationsToCheck) const;
	...
	/*virtual*/ ON_wString AddTexture(const CRhinoDib& dib, Location locationsToAddTo);
