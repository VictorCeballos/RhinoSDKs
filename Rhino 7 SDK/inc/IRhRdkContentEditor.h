...
public:
	...
	virtual HWND UiHostWindow(void) const = 0;

	/*virtual*/ UUID RdkDocumentId(void) const; // [SDK_UNFREEZE]
	/*virtual*/ void SetRdkDocumentId(const UUID& uuidRdkDoc); // [SDK_UNFREEZE]
