...
public:
  ...
  // justified.
  void PaintGradientTitleRect( CDC* pDC, LPRECT lpRect, LPCTSTR lpsCaption = 0, BOOL bActiveWindow = TRUE);
  //   
  // Description:
  //   
  //
  ...
  // to the resize list.  This will automaticly resize specified controls.
...
public:
  ...
  //   
  //   
  BOOL SetDlgItemToolTip( UINT nID, LPCTSTR lpsToolTip);
  //   
  // Description:
  //   
  //
  ...
  //   
  //   
  BOOL SetDlgItemToolTip( CWnd* pWndCtrl, LPCTSTR lpsToolTip);
  //   
  // Description:
  //   
  //
