...
public:
  ...
  BOOL HavePlane() const;
  void SetHavePlane( BOOL b = TRUE);
  ...
  void SetAllowCorners( BOOL allow = TRUE);
  BOOL AllowCorners();
  void SetAllowVertical( BOOL allow = TRUE);
  BOOL AllowVertical();
  void SetAllow3Point( BOOL allow = TRUE);
  BOOL Allow3Point();
  void SetAllowCenter( BOOL allow = TRUE);
  BOOL AllowCenter();

  void SetAllowRounded( BOOL allow = FALSE);
  BOOL AllowRounded();
  void SetRounded( BOOL allow = FALSE);
  BOOL Rounded();
  ...
  void SetAllowForceAspectRatio(BOOL allow = TRUE);
  BOOL AllowForceAspectRatio();
...
protected:
  ...
  BOOL m_allow_corners;
  BOOL m_allow_3point;
  BOOL m_allow_vertical;
  BOOL m_allow_center;
...
//////////
// Gets an oriented infinte plane
RHINO_SDK_FUNCTION
