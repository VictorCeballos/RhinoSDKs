...
public:
  ...
  /////////////////////////////////////////////////////////////////////////////
  // The SaveProfile*() funtions write to strings to the desired output location.
...
#if defined (ON_RUNTIME_APPLE)
  virtual bool LoadProfileInt(const wchar_t* lpszSection, const wchar_t* lpszEntry, BOOL*) const;
#endif
  ...
  // The default implimentation of the *ProfileBinary(...) methods simply return false, CRhinoRegProfileContext
  // is currently the only class that impliments these
...
// asociated with a CRhinoProfileContext;
//
