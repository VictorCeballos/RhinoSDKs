...
public:
  ...
  */
  virtual
  ON::object_type ObjectType() const = 0;
...
public:
  ...
  */
  virtual
  void DestroyMeshes( ON::mesh_type mesh_type, bool bDeleteMeshes = true );
...
public:
  ...
  CRhinoObjRef(
            ...
            BOOL bProxyGeometry // true if geometry is a proxy object that needs to be deleted
            );
  CRhinoObjRef(
            const CRhinoObject* object,  // object in doc
