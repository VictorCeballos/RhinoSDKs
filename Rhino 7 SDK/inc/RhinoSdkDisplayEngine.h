...
///////////////////////////////////////////////////////////////////////////
// Engine initialization and cleanup opertaions...
public:
  // Description:
...
public:
  ...
  // Description:
  //  Set the instance defintion transformation. This is the same as
...
public:
  ...
  //  label_offset- [in] distance in pixels lables are placed from axes
  ...
  virtual void DrawGroundPlane( const class CDisplayPipelineAttributes& dpa, const class CRhGLGroundPlane& groundplane );
  ...
  virtual void DrawHatch(const ON_Hatch& hatch, const class CRhinoDisplayBrush* fillBrush, const class CRhinoDisplayPen* boundaryPen, CRhinoCacheHandle* cacheHandle);
...
public:
  ...
  // Parameters:
  //  zbias: [in] new bias level to aply
  // Returns:
  ...
  // Parameters:
  //  plane: [in] index for plane to enable/diable. If -1, all planes
...
public:
  ...
  // We should always use this matrix to compute new model trasform
