...
public:
  ...
  //  embeded in a text dialog otherwise the user will be prompted for a text file name to
  ...
  //  hWndParent     [in] - Optional argument which is only meaningfull if is_interactive is
  ...
  // Description:
  //  Specify whether or not to use the file dialog when specifing a text file to write to.
  // Parameters:
  ...
  //  Specify whether or not to use the file dialog when specifing a text file to write to.
  // Returns:
  //  Returns true if the file dialog when specifing a text file to write to.
