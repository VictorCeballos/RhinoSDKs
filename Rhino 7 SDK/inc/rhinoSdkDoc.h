...
public:
  ...
  */
  ...
  /////////
  // Return associated RDK document
  //
  ON_DEPRECATED_MSG("Use the direct access functions below (Sun, Skylight etc")
    const class CRhRdkDocument& RdkDocument() const;

  /////////
  // Return associated RDK Sun interface
  //
  const class IRhRdkSun& Sun() const;

  /////////
  // Return associated RDK Skylight interface
  //
  const class IRhRdkSkylight& Skylight() const;

  /////////
  // Return associated RDK Ground Plane interface
  //
  const class IRhRdkGroundPlane& GroundPlane() const;

  /////////
  // Return associated RDK Safe Frame interface
  //
  const class IRhRdkSafeFrame& SafeFrame() const;

  /////////
  // Return associated RDK Current Environment interface
  //
  const class IRhRdkCurrentEnvironment& CurrentEnvironment() const;

  /////////
  // Return associated RDK Linear Workflow interface
  //
  const class IRhRdkLinearWorkflow& LinearWorkflow() const;

  /////////
  // Return associated RDK Dithering interface
  //
  const class IRhRdkDithering& Dithering() const;

  /////////
  // Return associated RDK Contents interface
  //
  const class IRhRdkContents& Contents() const;

  /////////
  // Return associated RDK Post Effects interface
  //
  const class IRhRdkPostEffects& PostEffects() const;

  /////////
  // Return associated RDK Render-Channels interface
  //
...
public:
  ...
  */
  ...
  void PageViewDetailIsActive(BOOL isActive);
...
public:
  ...
  Description:
    ...
    If the component is from a reference file like a worksession reference or a linked instance defintion with reference layers,
...
public:
  ...
  */
  int UnselectAll(
    BOOL bIgnorePersistentSelections = false
  );
...
public:
  ...
  */
  ...
  Returns:
    ...
    to create a cylic instance reference. If the creation point can be
...
public:
  // Overrides
    ...
    virtual void ReportSaveLoadException(LPCTSTR lpszPathName, CException* e, BOOL bSaving, UINT nIDPDefault) override;
    virtual BOOL SaveModified() override; // return TRUE if OK to continue
...
private:
  ...
  /*OBSOLETE*/ //virtual BOOL OnSaveDocument(LPCTSTR lpszPathName) override;
  /*OBSOLETE*/ //virtual BOOL DoSave(LPCTSTR lpszPathName, BOOL bReplace = true) override;
  /*OBSOLETE*/ //BOOL DoFileSave() override;
...
public:
  ...
  void SetPathName(LPCTSTR, BOOL bAddToMRU = TRUE);
...
public:
  ...
  */
  void IncludeLights(BOOL bIncludeLights = true);
  ...
  */
  void EnableSelectedFilter(BOOL b = true, BOOL bCheckSubObjects = false);
  ...
  /*
    ...
    See Also:
      ...
      CRhinoObjectIterator::EnableVisibleFilter
  */
  void EnableVisibleFilter(BOOL b = true);
