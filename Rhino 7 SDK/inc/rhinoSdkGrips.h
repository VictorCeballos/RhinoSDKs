...
#pragma region All grips virtual function interface
  ...
  */
  ...
  Parameters:
    ...
    bSynchHighlight - [in] if true, highlight state is 
             syncronized with selection state.
  ...
  */
  ...
  Parameters:
    cv_i - [in]
  Returns:
    A grip controling a NURBS curve CV or NULL.
  */
  virtual
  ...
  */
  ...
  Parameters:
    ...
    cv_k - [in]
  Returns:
    A grip controling a NURBS cage CV or NULL.
  */
  virtual
...
/*
Description:
  This class is useful when grip informaton needs to be duplicated
