...
public:
  ...
  Description:
    ...
    models in worksessions. When a linked instance defintion
  ...
  */
  ...
  Returns:
    ...
    >1000:
      ...
      be used to find the instance defintion.
  Remarks:
    The linked instance defintion serial number is a runtime value.
  ...
  */
  ...
  Returns:
    ...
    from a linked instance definiton or the layer tree from
  ...
  */
  ...
  Returns:
    True if the layer is a parent layer of the layer tree
    from a linked instance definiton model.
  See Also:
    CRhinoLayer::WorksessionReferenceModelSerialNumber
    CRhinoLayer::LinkedInstanceDefinitionSerialNumber
    CRhinoLayer::IsReference
...
private:
  ...
  //   2:  This is a linked idef parent layer contianing the layer
  ...
  //       identifies the lined instance defintion.
...
public:
  ...
  //
  // Returns:
  //   Refererence to the layer.  If layer_index is out of range,
  ...
  */
  ...
  Remarks:
    Layers with differnt parents may have identical names.
  */
  ...
  */
  ...
  /*
  Description:
    Basic tool used by the add layer fucntions.
  Parameters:
    layer - [in]
    ...
    layer_type - [in]
      0: ordinary layer
      2: linked instance definiton "filename.3dm" parent layer of 
  ...
  */
  ...
  Parameters:
    layer_name - [in]
      If the name is nullptr or an empty string, an unsused layer name
...
Remarks:
  ...
  to repaint. To add bulk layers expeditiously, you will want to:
    ...
    4.) Redraw the layer manager window by calling RhinoRedrawLayerManagerWindow().
*/
RHINO_SDK_FUNCTION
