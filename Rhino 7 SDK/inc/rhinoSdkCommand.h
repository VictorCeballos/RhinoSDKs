...
public:
  ...
  */
  ...
  Description:
    ...
    Project and Interesect need to override the complex
  ...
  */
  ...
  Remarks:
    ...
    for the command.  Under no circustances should enable
  ...
  */
  ...
  Remarks:
    ...
    and "script running" commands need to be treated a litte
  ...
  */
  ...
  void EnableRepeatable(BOOL bRepeatable=true);
...
public:
  ...
  */
  ...
  Description:
    ...
    were selected.  If you want to supress this message,
...
public:
  ...
  void TransformObjects(CRhinoDoc& doc, class CRhinoXformObjectList& list, ON_Xform& xform, BOOL bCopy = FALSE, BOOL bAutoHistory = FALSE);
...
// and frees command developers from having to carefuly 
...
public:
  ...
  */
  ...
  Description:
    ...
    will be used to update the command's ouput objects
    if an input changes.
  Parameters:
    cmd - [in]
  Remarks:
