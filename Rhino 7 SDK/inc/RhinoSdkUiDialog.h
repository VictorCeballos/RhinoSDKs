...
//       ...
//     }
//   This will allow your window to recieve PreTranslateMessage() calls.  Another option is
//   to add the member to your CRhino....PlugIn derived class and intialize in the same manner
//
...
public:
  ...
  //   and embeded in a container that handles mouse down events.
  //
  // Parameters:
  ...
  //
  // Returns:
  //   The default behaivor is to return false.  To change this you will
