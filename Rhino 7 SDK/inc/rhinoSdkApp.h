...
public:
  ...
  */
  ...
  Remarks:
    ...
    functions. The create a prompt that is correctly formated.
  ...
  */
  ...
  RHINO_SDK_FUNCTION
  BOOL AddMenuItem( HMENU hTargetMenu, UINT index, MENUITEMINFO* pMi, CRhinoPlugIn* pApp);

  //STEVEBAERV6// - Need to chat with John about plan for supporting menu in V6
  RHINO_SDK_FUNCTION
  BOOL AddMenu( HMENU hSubMenu, LPCTSTR title, CRhinoPlugIn* pApp);
  ...
  //STEVEBAERV6// - Need to chat with John about plan for supporting menu in V6
  RHINO_SDK_FUNCTION
  BOOL RemovePlugInAddedMenu( HMENU hmenu, CRhinoPlugIn* plug_in);
  ...
  */
  ...
  RHINO_SDK_FUNCTION
  BOOL AddPageToObjectPropertiesDialog(
  ...
  */
  ...
  RHINO_SDK_FUNCTION
  BOOL RemovePageFromObjectPropertiesDialog(
    class IRhinoPropertiesPanelPage* pPage);
  ...
  */
  RHINO_SDK_FUNCTION
  BOOL RegisterCommand(CRhinoCommand* pCommand);
...
#if defined(ON_RUNTIME_WIN)
#if defined (RHINO_SDK_MFC)
  BOOL RhinoProcessShellCommand( CCommandLineInfo& rCmdInfo, int mode);
#endif
#endif
...
private:
  // Moving profile context to private section, these should be accessed using
...
public:
  ...
  RHINO_SDK_FUNCTION BOOL PumpMessage();
