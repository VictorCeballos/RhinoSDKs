...
public:
 ...
 /*
    ...
    Returns:
      ...
      False    Failure
  */
  BOOL Corners( ON_3dPoint rect[4]) const;
...
protected:
  BOOL CalcCorners( CRhinoViewport& vp, const ON_3dPoint& point, ON_3dPoint corners[4]) const;
...
public:
  ...
  BOOL CalcCorner( const ON_3dPoint& dragpoint, double& radius, double& rho);
