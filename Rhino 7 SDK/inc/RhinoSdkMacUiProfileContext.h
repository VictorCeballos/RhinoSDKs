...
public:
  ...
  void SaveProfileBool(const wchar_t* lpszSection, LPCTSTR lpszEntry, BOOL ) const;
  bool LoadProfileBool(const wchar_t* lpszSection, LPCTSTR lpszEntry, BOOL* ) const;
  bool LoadProfileBool(const wchar_t* lpszSection, const wchar_t* lpszEntry, BOOL* value, BOOL defaultValue) const;
  ...
  bool LoadProfileInt(const wchar_t* lpszSection, LPCTSTR lpszEntry, BOOL* ) const;
