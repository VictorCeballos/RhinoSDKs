...
public:
  ...
  */
  ...
  BOOL Prepend( class CRhinoPolyEdgeSegment* new_segment ); // Prepend curve.
  BOOL Append( class CRhinoPolyEdgeSegment* new_segment );  // Append curve.
  BOOL Insert( 
           int segment_index,
  ...
  /*
  Description:
    The CRhinoPolyEdge EvSrf... tools can evaulate the 
    ...
    tmPerp     srf tangent will be perpindicular to edge
  See Also:
