...
public:
	...
	/** \return The ids of the data sources needed to make tasks work. */
	...
	enum class SubMenus
	{
		...
		PlugIn,     // Custom task will appear in a sub-menu with the current plug-in's name.
	};
...
RHRDK_SDK IRhRdkTaskOrigin* RhRdkNewCreateNewButtonTaskOrigin(CRhRdkControllerPtr con, CRhRdkContent::Kinds kind);
