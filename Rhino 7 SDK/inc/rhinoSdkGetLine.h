...
public:
  ...
  */
  BOOL AcceptZeroLengthLine() const;
  ...
  */
  void EnableAcceptZeroLengthLine( BOOL = TRUE );
...
protected:
  ...
  BOOL m_bHaveStartPoint;

  // [in]
  BOOL m_bAcceptZeroLengthLine;
  ...
  BOOL m_bEnableBothSidesOption;

  BOOL m_bShowVariations;
...
public:
  ...
  CRhinoGetPolylinePoint* GetPolylinePoint(void);
  
  BOOL m_bFromMidpoint;
