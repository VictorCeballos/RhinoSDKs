...
public:
  ...
  //   are to be embeded in this dock bar should be created.
  // Returns:
  //   true If controls are created succesfully.  false If they are not.  Returning
  ...
  // Description:
  //   Called by CRhinoUiDockBar::CalcFixedLayout just prior to commiting size.
  ...
  virtual CSize OnCalcFixedLayout(CSize size, BOOL bStretch, BOOL bHorz);

  // Description:
  //   Called by CRhinoUiDockBar::CalcDynamicLayout just prior to commiting size.
  //   Override if you want the size to snap at specific increments.
  // Parameters:
  //   size [in] New calculated size.
  ...
  //   specified location.  This is may be usefull when setting minimum, maximum
  //   and initial sizes.
  // Parameters:
  ...
  //   main frame window.
  // Returns:
  //   true If the dock bar is docked on the rigth side.
...
public:  
  ...
  BOOL SetStatusText(INT_PTR nHit) override;
