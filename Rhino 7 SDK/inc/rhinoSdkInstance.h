...
public:
  ...
  */
  ...
  /*
  Description:
    Returns true if some object in the instance defintion
    is on the layer with index layer_index.
  Parameters:
    layer_index - [in] index of layer to search for
  Returns:
    True if there is an object in the instance defintion
...
public:
  ...
  */
  ...
  /*
  Description:
    Find the instance defintion that has the specified
    serial number.
  Parameters:
    sn - [in]
      runtime serial number
...
public:
  ...
  */
  ...
  Parameters:
    ...
    viewport_id - [in]
      If bSkipHiddenPieces is false, then viewport_id is ingored.
...
public:
  ...
  ON_wString OnDoubleClick(const CRhinoDoubleClickContext&) const;
...
/// It safely iterates nested instance defintions in a way that protects against infinite looping when damaged models
...
public:
  ...
  /// <summary>
  /// Create an iteratator to interate the objects referenced by iref.
  /// </summary>
  /// <returns></returns>
  CRhinoInstanceObjectIterator(const CRhinoInstanceObject* iref);

  /// <summary>
  /// Initialize this to interate the objects referenced by iref.
  /// </summary>
