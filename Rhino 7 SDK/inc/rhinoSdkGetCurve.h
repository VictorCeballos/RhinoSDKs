...
// interpolated curve end tangent, ON_3dVector(0,0,0) if not defined
  ...
  Remarks:
    ...
    If SubDFriendly() is true, then degree, knot spacing, and end condition paramaters are ignored
...
protected:
  ...
  BOOL m_UseStartTangent = false;

  // If 3 == m_Degree and m_bSubDFriendly is true, then
  // m_UseEndTangent is ignored.
  BOOL m_UseEndTangent = false;
...
/*
Description:
  Interactively get a contol point curve.
Parameters:
