...
// defines for this verison information.
//
...
//////////////////////////////////////////////////////////////////////
//
// Todo - move the following defines to a file that is rarely inluded
...
// You can use string concatination for strings that are not
// explicitly defined.
// Example:
...
//
// NOTE WELL:
//   It is intentional that the values of RHINO_SDK_WINDOWS_VERSION for Rhino 6 and Rhino 7 are identical.
//
//   The Rhino 7 SDK is an extended version of the Rhino 6 SDK.
//   Rhino 7 loads Rhino 6.* plug-ins.
//   Thus, the Rhino 7 and Rhino 6 have identical values for RHINO_SDK_WINDOWS_VERSION.
