...
public:
  ...
  virtual BOOL OnAssignMaterial( HWND hwndParent, ON_Material& material, CRhinoDoc& doc);
  //////////////////////////////////////////////////////////////////////////////////
  ...
  virtual BOOL EnableAssignMaterialButton() const;
  ////////////////////////////////////////////////////////////////////////////////////////////
  // This function is called by the Object Properties and Layer Control dialogs
  ...
  virtual BOOL OnEditMaterial( HWND hwndParent, ON_Material &material, CRhinoDoc& doc);
  //////////////////////////////////////////////////////////////////////////////////
  ...
  // function is never called.
  virtual BOOL EnableEditMaterialButton(ON_Material &material, CRhinoDoc& doc) const;
  ////////////////////////////////////////////////////////////////////////////////////////////
  // This function is called by the Object Properties and Layer Control dialogs
  ...
  virtual BOOL OnCreateMaterial(HWND hwndParent, ON_Material &material, CRhinoDoc& doc);
  //////////////////////////////////////////////////////////////////////////////////
  // Called to enable/disable the "New" button located on the "Material" in the 
  // Properties and Layer dialog boxes.  The default return value is false 
  // which will disable the button.  If the button is disabled then the OnEditMaterial
  // function is never called.
  virtual BOOL EnableCreateMaterialButton() const;
  //////////////////////////////////////////////////////////////////////////////////
  // Message sent from script to save file
  //////////////////////////////////////////////////////////////////////////////////
  virtual BOOL SaveRenderedImage( ON_wString wFileName);
  //////////////////////////////////////////////////////////////////////////////////
  ...
  //////////////////////////////////////////////////////////////////////////////////
  virtual BOOL CloseRenderWindow();
  //////////////////////////////////////////////////////////////////////////////////
  ...
  //////////////////////////////////////////////////////////////////////////////////
  virtual void OnSetCurrentRenderPlugIn( BOOL bCurrent);
  //////////////////////////////////////////////////////////////////////////////////
