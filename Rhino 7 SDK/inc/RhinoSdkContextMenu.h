...
public:
  ...
  //                in the MSDN help file for details.  This bitmap will be coppied so it is up to you to delete it when you are done.
  ...
  // Description:
	//   Convert original sub menu ID to runtime ID which was used in this menu.  This is usefull when initializing the menu at runtime.
  // Parameters:
  ...
  // Parameters:
  //   nItem [in] Item reference index returned by AddItem()
  //   lps [in] Text to be displayed if status bar is sychronized
  ...
  // Parameters:
  //   hWnd [in] Window that recieved the message
  ...
  // Description:
	//   Menu handel for the context menu to be displayed
  HMENU GetMenuHandle();
...
public:
  ...
  // Description:
	//   Required virtual override.  You MUST override this method and return ture if you
  ...
  //   returns true.  This is called by Rhino after a separator has been added to the specifed
  ...
  //                 call the AddItem() mehtods on this object to extend the menu
