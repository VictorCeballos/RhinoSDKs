...
public:
  ...
  virtual BOOL CreatePopUpListBox( const RECT& rect, CWnd* pParentWnd, UINT nListBoxStyles = LBS_HASSTRINGS|LBS_NOINTEGRALHEIGHT);
  ...
  //
  virtual BOOL OnLBOnLButtonUpInColumn( int item, int x_down, int x_up);
  // Desctiption:
