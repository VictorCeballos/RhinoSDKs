...
protected:
  ...
  //   
  // Description:
  //   Call this method to draw text lable for this tab control item.
  //
  // Parameters:
  //   dc [in] Device context to draw to
  //   orientation [in] Current display postion for tabs
  //
  // Returns:
...
//   Add this method to the class implimention
...
//
// See Also:
//   RegisterWindowMessage() in the Platfrom SDK
//   ON_REGISTERED_MESSAGE in the Platfrom SDK
//
...
public:
  ...
  enum orientation
  {
    orient_top = 0, // Display tabs at top of control with pages bellow
  ...
  //   values:
  //      orient_top         Display tabs at top of control with pages bellow
  //      orient_left        Display tabs on left side of control with pages to the right
  //      orient_right       Display tabs on right side of control with pages to the left
  ...
  //   
  // Description:
  //   Call this method to enable or disalbe the display of the "First" and "Last" scroll buttons. The
  ...
  //
  // Returns:
  //   Retuns true if "Next" and "Previous" buttons are visible otherwise false.
  //
  // See Also:
  //   CRhinoUiTabbedSheetCtrl::IncludeFirstAndLastButtons()
  //   
  ...
  //
  // Returns:
  //   Pointer to a CRhinoUiTabbedSheetCtrlItem which contains infomation about the tab.
  //
  // See Also:
  ...
  //   
  // Description:
  //   Remove item from display but not from tab control.  This is usefull to temporarily
  ...
  //   are drawn using ::GetSysColor( COLOR_BTNFACE).  You may override this behaivor by setting
  ...
  //
  // Returns:
  //   Returns a pointer to the in-place edit control if successfull otherwise returns NULL.
  //
  // See Also:
...
protected:
  ...
  //
  // Returns:
  //   Returns value recieved by CWnd::SendMessage().
  //
  // See Also:
  //   CWnd::SendMessage()
