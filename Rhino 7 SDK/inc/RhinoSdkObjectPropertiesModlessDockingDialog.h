...
protected:
  ...
  virtual BOOL AddPageToControlBar( const CRhinoObject* obj = NULL) const;
  ...
  enum page_type
  {
    ...
    light_page,         // Replace ligth page with this page, only works are the current render plug-in
