...
public:
  ...
  */
  ...
  /*
  Returns:
    Envrionment map bitmap or NULL
  */
...
public:
  ...
  //
  // Returns:
  //   Refererence to the material.  If material_index is out of range,
   ...
   Parameters:
    ...
    linked_idef_sn - [in]
     ...
     1-1000: reserved for future use
      >1000: material instance defintion serial number      
  ...
  */
  ...
  // Description:
  //   If the material has been modified and the modifcation can be undone,
...
public:
  ...
  // is available but poorly designed code reqires a material.
