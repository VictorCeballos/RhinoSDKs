...
public:
  ...
  //                 macro with the following to allow data validation:
  //                    m_MyEditControl.DDX_Text( pDX, nIDC, m_nMyIntProperty);
  //     et_ip,    - Windows IP imput control
  //   
  enum edit_type
  {
  ...
  //   
  // Description:
  //   Returns the current decimal display precison when the
  ...
  //   
  // Description:
  //   Sets the current decimal display precison when the
  //   control is displaying double values (CRhinoUiEdit::et_double).
  //
  // See Also:
  //   CRhinoUiEdit::SetEditType()
  ...
  //   
  // Description:
  //   If this method returns true a spinner control will be created and embeded
  ...
  //   true then a spinner control will be created and embeded in this edit control.
  //   Use the GetSpinButtonCtrl() method to gain access to the embeded control.
  //
  // Parameters:
  ...
  //   
  // Notes:
  //   Constructor sets has minimum falg to FALSE
  ...
  //             must contain at least one charachter.
  //
  ...
  //   
  // Description:
  //   Get spin button control embeded in this edit control.
  //
  // Returns:
