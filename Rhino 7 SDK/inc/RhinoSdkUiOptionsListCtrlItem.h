...
public:
  ...
  enum control_type
  {
    ...
    ct_color_combo_box,  // CRhinoUiOptionsListCtrlComboBox - Combo box containg list of standar colors and/or custom color option
  ...
  //   then this object is deleted automaticly when the options list is destroyed.  Use the SetAutoDelete() method to
  //   change this value.
  //
  // Returns:
  ...
  //   will be deleted automaticly when the options list is destroyed.
  //
  // Parameters:
  ...
  //
  // Returns:
  //   The current lable for this item or NULL if no label.
  //
  // See Also:
  ...
  //
  // Parameters:
  //   lpsLabel [in] New lable, not allowed to be NULL.
  //
  // Returns:
  ...
  //
  // Returns:
  //   Retruns unique runtime ID for this item.
  //
  ...
  //
  // Parameters:
  //   iIndentLevel [in] Number of indents to preceed this item lable.
  //
  // Returns:
  //   Returns previous value.
  //
...
protected:
  ...
  //
  // Returns:
  //   Should return true if the control has been succesfully created; otherwise false.
  //
  virtual bool BeginEditItem( CRhinoUiOptionsListCtrl& list_ctrl, const CRect rEdit, begin_edit_item_reason eir) = 0;
  //   
  // Description:
  //   This method is called when a column or options list contorl has been resized while a item control is
  //   visisble.
  //
  // Parameters:
...
protected:
  ...
  //
  // Returns:
  //   Returns true if WM_MOUSEWHEEL message whould be forwarded to options list control
  //
  // See Also:
  //   CWnd::OnMouseWheel()
  //   
...
public:
  ...
  //   changed while the control is visble.
  //
  // Parameters:
  ...
  //
  // Returns:
  //   Returns true since the IP control validates imput as it is made.
  //
  // See Also:
  ...
  //   
  // Description:
  //   Get the last valid IP address imput.
  //
  // Returns:
  //   Returns a long value which identifies the IP addresss.
  ...
  //   IPM_SETADDRESS window messsage
  //   MAKEIPADDRESS macro
  //   
...
public:
  ...
  //   to be populated with data.  If this method retuns false the combo box will destroyed.
  //
  //   The default implimentation of this method sends a CRhinoUiOptionsListCtrl::m_custom_win_msg_id
  ...
  //
  // Parameters:
  //   b [in] If truen then the list box is shown automaticaly; otherwise it is not.
  //
  // Returns:
...
public:
  ...
  //   
  // Description:
  //   Call this method to allow or dissallow adding of "By Layer" linetype option to combo
  //   box.
  //
  // Parameters:
  ...
  //   
  // Description:
  //   Call this method to allow or dissallow adding of "By Parent" linetype option to combo
  //   box.
  //
  // Parameters:
  ...
  //   
  // Description:
  //   Call this method to allow or dissallow adding of default linetypes option to combo
  //   box.
  //
  // Parameters:
  ...
  //   
  // Description:
  //   Call this method to allow or dissallow adding of deleted linetypes to the combo box.
  //
  // Parameters:
  ...
  //   
  // Description:
  //   Call this method to allow or dissallow adding of reference linetypes to the combo box.
  //
  // Parameters:
...
public:
  ...
  //   
  // Description:
  //   Call this method to allow or dissallow adding of "By Layer" width option to combo
  //   box.
  //
  // Parameters:
  //   b [in] If truen then "By Layer" option is added to combo box; otherwise it is not.
  ...
  //   
  // Description:
  //   Call this method to allow or dissallow adding of "By Parent" width option to combo
  //   box.
  //
  // Parameters:
  //   b [in] If truen then "By Parent" option is added to combo box; otherwise it is not.
  ...
  //   
  // Description:
  //   Call this method to allow or dissallow adding of the default option to the width list
  //
  // Parameters:
  ...
  //   
  // Description:
  //   Call this method to allow or dissallow adding of the "No Print" option to the end of the width list
  //
  // Parameters:
  ...
  //   
  // Description:
  //   Call this method to allow or dissallow adding of the "Hairline" option to the width list
  //
  // Parameters:
...
//
//   Display a combo box containing a list of currenlty installed fonts.  This list may be filtered
...
public:
  ...
  //
  // Parameters:
  //   lf[out] LOGFONT structure to recieve font information.
  //
  // Returns:
...
public:
  ...
  //   
  // Description:
  //   Call this method to allow or dissallow adding of "By Layer" color option to combo
  //   box.
  //
  // Parameters:
  //   b [in] If truen then "By Layer" option is added to combo box; otherwise it is not.
  ...
  //   
  // Description:
  //   Call this method to allow or dissallow adding of "By Parent" color option to combo
  //   box.
  //
  // Parameters:
  //   b [in] If truen then "By Parent" option is added to combo box; otherwise it is not.
...
public:
  ...
  //   
  // Description:
  //   Call this method to allow or dissallow adding of deleted layers to the combo box.
  //
  // Parameters:
  ...
  //   
  // Description:
  //   Call this method to allow or dissallow adding of reference layers to the combo box.
  //
  // Parameters:
...
public:
  ...
  //
  // Returns:
  //   Returns ture if mouse is currently down over this item.  Used when drawing item
  //   durring selection process.
  //
