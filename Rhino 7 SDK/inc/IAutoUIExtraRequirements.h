...
/** \class IAutoUIExtraRequirements
	...
	- RDK_COMBOBOX
	- RDK_DATETIME_LOCATION       Requests a callback for providing location information to the date/time control.
	- RDK_LOCATION_DATETIME       Requests a callback for providing date/time information to the location control.
...
// Extra requirement for date/time control earth location.
#define RDK_DATETIME_LOCATION           L"datetime-location"           // Specifies 'datetime location' extra requirement. Implied return value must be vtVector2d.

// Extra requirement for location control date/time.
#define RDK_LOCATION_DATETIME           L"location-datetime"           // Specifies 'location datetime' extra requirement. Implied return value must be vtTime.
...
#define RDK_DATETIME_SUN_LOCATION   DEPRECATED L"Please use RDK_DATETIME_LOCATION"
#define RDK_LOCATION_SUN_DATETIME   DEPRECATED L"Please use RDK_LOCATION_DATETIME"
