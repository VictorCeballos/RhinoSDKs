...
/** Although most of the UI is in the RDK UI plug-in, there are a few dialogs
	that are required to remain in the RDK core as SDK services. These are:
...
/** Show a file dialog for loading one or more contents.
	...
	\param aFullPathsOut accepts one or more file names chosen by the user.
...
/** Show a file dialog for saving a content.
	...
	\param sFullPathOut accepts the full path chosen by the user.
	\return \e true if the user chose a file, \e false if cancelled. */
