...
// OBSOLETE - Depending on what you want to do
// use tools from RhinoSdkVersion.h
#define RHINO_V7SR 0
...
#if defined(_MSC_VER)
#if defined(_DEBUG)
  #pragma message( " --- rhinoSDK.h --- Building Debug Rhino V6 plug-in" )
#else
  #pragma message( " --- rhinoSDK.h --- Building Release Rhino V6 plug-in" )
#endif
#endif
...
#if ( 1900 <= _MSC_VER )
#pragma message( " --- rhinoSDK.h --- Using Visual Studio 2017 compiler tools." )
#else
#error Rhino V6 cannot use this version of the compiler.
#endif
...
#if ( 0x0E00 == _MFC_VER )
#pragma message( " --- rhinoSDK.h --- Using v140 Windows Platform SDK (MFC 14.1, VS 2017)." )
#else
#error Rhino V6 cannot use this Windows Platform SDK.
#endif
...
#if defined (ON_RUNTIME_APPLE)
// Include OS X definitions of Windows symbols
#include "../../AfxMac.h"
#endif
