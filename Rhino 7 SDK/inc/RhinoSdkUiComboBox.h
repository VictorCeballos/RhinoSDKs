...
public:
  ...
  //                CRhinoLayerTable::Sort() is called using the compare paramater prior to calling 
  //                CRhinoLayerTable::GetSortedList().
  //   cull [in] Only valid if bUseSortedList is false. If so and cull is not NULL then
  //                CRhinoLayerTable::Sort() is called using the cull paramater prior to calling 
  //                CRhinoLayerTable::GetSortedList().
  ...
  //                       otherwise iterate the linetype table and apply the comapre and cull methods is specified.
  ...
  //                                 bottom of the list.
  //   compare [in] Only valid if bUseSortedList is false. If so and compare is not NULL then
  //                CRhinoLinetypeTable::Sort() is called using the compare paramater prior to calling 
  //                CRhinoLinetypeTable::GetSortedList().
  //   cull [in] Only valid if bUseSortedList is false. If so and cull is not NULL then
  //                CRhinoLinetypeTable::Sort() is called using the cull paramater prior to calling 
  //                CRhinoLinetypeTable::GetSortedList().
  ...
  //   defintion file.  When the combo box fills the list with these items it generates unique 
  ...
  //   string is coppied to result and true is returned. If cx is not a CRhinoUiComboBox::print_width_options
  ...
  //   bQueitly [in] If this is true then this function will fail quietly otheriwse a message box will
  //                 appear on error.
  //
  // Returns:
  ...
  //   
  // Description:
  //   Find list item with specified print widht set it as currently selected item.
  //
  // Parameters:
  ...
  //
  // Returns:
  //   Returns a CRhinoUiComboBox::print_width_options or valid width value on succes or
  ...
  //   
  // Description:
  //   This method is called when a CBN_EDITCHANGE message is recieved and this combo box
  //   The current value in the edit control is validated and converted to a valid widht
  //   if possible.
  //
  // See Also:
  ...
  //   
  // Description:
  //   This method is called when a CBN_EDITUPDATE message is recieved and this combo box
  //   The current value in the edit control is validated and converted to a valid widht
  //   if possible.
  //
  // See Also:
  ...
  //
  // Parameters:
  //   lf_out [out] Currently selected LOGFONT is coppied here.
  //
  // Returns:
  //   Zero based index of currently selected item whos LOGFONT was coppied.
