...
public:
  ...
  Remarks:
    This is a safe and reliable funtion.

  Example:
    Commands that create ON_SubD objects should do somthing like the following:
  ...
  */
  ...
  Remarks:
    ...
    and precisely control the managment of userdata attached to the ON_SubD.
  */
  ...
  Example:
    ...
    ...
    ... anything can happen includeing delete subd_object.
    ...
  ...
  */
  ...
  Returns:
    referece to the ON_SubD this CRhinoSubDObject uses for its geometry.
  */
  const ON_SubD& SubD() const;
...
public:
  ...
  */
  ...
  /*
  Returns:
    True if the dyanmic display from this->SubDisplay(true) is
