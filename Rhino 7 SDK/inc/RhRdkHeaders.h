...
#include "RhRdkDataSource.h" // This is not supposed to be in the public SDK. [SDK_UNFREEZE]
...
#include "RhRdkUiSdk.h" // This is not supposed to be in the public SDK. [SDK_UNFREEZE]
#include "RhRdkUuid.h"
