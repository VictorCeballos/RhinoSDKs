...
public:
  ...
  */
  ...
  //
  // Returns:
  //   Refererence to the style.  If style_index is out of range,
  ...
  */
  ...
  Parameters:
    dim_style - [in/out]
      If dim_style has no name or an empty name, then a unique name is assined.
   ...
   Parameters:
    ...
    linked_idef_sn - [in]
     ...
     1-1000: reserved for future use
      >1000: dimstyle instance defintion serial number
...
private:
  ...
  Description:
    ...
    when the model_space_text_scale paramter is unset or not valid.
