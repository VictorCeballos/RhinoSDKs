...
public:
  ...
  // and should not tranform objects.
...
public:
  ...
  Returns:
    Selected item.  The caller is reponsible for actually doing
...
{
public:
  CRhinoGumballDisplayConduit(CSupportChannels channel_mask=CSupportChannels::SC_CALCBOUNDINGBOX|CSupportChannels::SC_DRAWOVERLAY);
  ...
  Description:
    ...
    just constructed.  Use this fuction when you'd like to
  ...
  */
  ...
  // The inital mouse down event sets m_pick_result
