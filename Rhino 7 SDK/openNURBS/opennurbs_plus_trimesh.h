...
public:
  ...
  */
  ...
  //
  //  (m_T_flags[ti] & 0x3F):
  //     The low six bits (m_T_flags[ti] & 0x3F) specifie how
  ...
  Remarks:
    ...
    R-tree or Vmap informtion may be invalid and should be
    destroyed.
  */
  ...
  */
  ...
  Returns:
    Null if this mesh is not valid, othewise a pointer to an
