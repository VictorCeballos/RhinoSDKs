...
{
public:
  ON_MeshIntersectionCache() = default;
  ~ON_MeshIntersectionCache();
  class ON_MeshIntersectionCacheImplementation;
  ON_MeshIntersectionCacheImplementation* m_impl = nullptr;
private:
  ...
  */
  ...
  Parameters:
    ...
    planar_tolerance - [in]
      ...
      This tolerance is used to determine when the bondary points should
    ...
    points2d_list - [out]
      ...
      caclulate the triangulation are returned here. points2d_list[i]
...
*/
  ...
  Parameters:
    ...
    tolerance - [in]
      ...
      coeffiecient to scale the document tolerance to a suitable value, while accepting a user-provided value.
...
*/
  ...
  */
  ...
  /*
  Description:
    Carefully intersect this mesh with meshB. This method currently uses the old code.
  Parameters:
    meshB - [in]
...
Parameters:
  ...
  max_dist - [in]  Do not search for point pairs further appart than max_dist
...
Parameters:
  ...
  edge_side - [in] if nullptr, the triangles are built on the left side
                   of the edges.  If not nullptr, then
...
public:
  ...
  Parameters:
    ...
    mesh_id - [in]
      Vaue of that is assigned to ON_MeshXPoint.m_mesh_id.
  */
  ON_MeshX(    
    const ON_Mesh& mesh,
  ...
  */
  ...
  Returns:
    ...
    mesh before it is interesected with the plane.
  */
  ...
  Returns:
    ...
    to the mesh before it is interesected with the plane.
  */
  ...
  Parameters:
    xform - [in]
      transformation that is conceptually appied to the
  ...
  */
  ...
  // convienience of the caller.  The ON_MeshX class never
  // uses this pointer
  const ON_Mesh* m_mesh;
  ...
  // mesh plane interesections.  The values of these fields are
  ...
  */
  ...
  Parameters:
    ...
    bc_tolerance - [in] (use 0.0 when in doubt)
      ...
      then the barycentric coordinate is set to zero.
    plane_id - [in]
      Vaue of that is assigned to ON_MeshXPoint.m_other_id.
  Remarks:
    This function is not thread safe.  If you want to use multiple threads
    to interesect multiple planes with the same mesh, then create a local
...
public:
  ...
  */
  ...
  Remarks:
    This function is not thread safe.  If you want to use multiple threads
    to interesect multiple lines with the same mesh, then create a local
...
public:
  ...
  */
  ...
  Returns:
    ...
    false:
      No point is avaialble.  Either the ON_MeshThicknessAnalysis has no points
