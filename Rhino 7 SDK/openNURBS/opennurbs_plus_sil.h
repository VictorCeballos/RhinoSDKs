...
public:
  ...
  */
  ...
  END_TYPE m_end_type[2];	
	...
	// A typical example is ON_SIL_EVENT that starts and ends on ON_BrepEdges and goes acorss the interior of face.
	// In this case m_ci will be the component index of the face, m_end_ci[0] and  m_end_ci[1] will be the 
	// component indicies of the edges on which the ON_SIL_EVENT terminates, m_end_type[0] and  m_end_type[1] will
  ...
  */
  ...
  of the projected silhoutte curve is filled.
...
public:
  ...
  Parameters:
		...
		angleToleranceRadians -[in]   A surface with unit normal N that saisfies
  ...
  */
  ...
  /* 
	Description:
		Specify the parameters for calculating draft curves.  The draft curve seperates
  ...
  Parameters:
		...
		draftAngleRadians -[in]  draft angle can be positve or negative
		tolerance - [in]
