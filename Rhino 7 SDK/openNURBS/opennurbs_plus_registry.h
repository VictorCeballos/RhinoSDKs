...
private:
  ...
  */
  ...
  Description:
    ...
    specified by m_key_path. The resulting HKEY has KEY_READ priviliges, but cannot write 
  ...
  */
  ...
  Description:
    OpenKeyRead opens the key indicated in the hive specified by m_root, with the path 
    specified by m_key_path. The resulting HKEY has KEY_WRITE priviliges, meaning it 
