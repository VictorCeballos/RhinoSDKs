...
public:
  ...
  */
  ...
  Remarks:
    ...
    one of them one time before proceding.
  */
  ...
  */
  ...
  Returns:
    True if mesh is successfully marked.  The mark informtion is
    ...
    MarkComponents() increments m_marking_error_count everytime it 
