...
#pragma region RH_C_SHARED_ENUM [ON_SubD::SubDFriendlyKnotType] [Rhino.Geometry.SubDFriendlyKnotType] [byte]
  ...
  */
  ...
  /*
  Description:
    Create a subd that approsimates the surface. 
  ...
  */
  ...
  bOffsetSurface - [in]
    If true, the offset is caluclated by interpolating offet surface points.
...
public:
  ...
  Description:
    ...
    No conincidence checking or merging is performed.
...
public:
  ...
  Parameters:
    ...
    bMergeAllCoincidentVertices - [in]
      ...
      If false, only conincident corner vertices and conindident crease edges with at 
  ...
  */
  ...
  Parameters:
    ...
    triangluation_plane_normal - [in]
      ...
      for calculating the boundary triangulation. Othewise, the plane normal
...
public:
  ...
  */
  ...
  /*
  Description:
    Combine (merge / weld) conincident vertices into single vertex.
  Parameters:
    ci_list - [in]
      A list of vertices to consider for combining.
    combined_vertex_tag - [in]
      Sugggested vertex tag for combined vertices.
  Returns:
  ...
  */
  ...
  /*
  Description:
    Combine (merge / weld) conincident vertices into single vertices.
  Parameters:
    vertex_list - [in]
      A list of vertices to consider for combining.
    combined_vertex_tag - [in]
  ...
  */
  ...
  Parameters:
    ...
    combined_edge_tag - [in]
      Prefered tag for the combined edge
  Returns:
  ...
  */
  ...
  Parameters:
    edge_chains - [in]
      edge chains that will be separated into conincident boundary edges.
    separated_edges - [out]
  ...
  */
  ...
  Parameters:
    edges - [in]
      edges that will be sorted into edge chains that will be separated into conincident boundary edges.
    separated_edges - [out]
      If not null, the pairs of separated edges are returned here.
      separated_edges[].First().EdgePtr() will be an original edge.
      separated_edges[].Second().EdgePtr() will be a new edge edge.
  ...
  */
  ...
  /*
  Description:
    Separate (unweld) an interior edge into two conincident boundary edges.
  Parameters:
    edge - [in]
  ...
  */
  ...
  Parameters:
    vertex - [in]
      ...
      Othewise the vertex is separated into single face sectors.
    separator0 - [in]
    separator1 - [in]
  Returns:
    If separation occured, then an array of the separated vertices is returned with the original vertex is the first element in the array.
  ...
  */
  ...
  Parameters:
    vertex - [in]
      If the vertex is a nonmanifold vertex with multiple manifold sectors, it is separated into manifold sectors.
    bApplyCreaseBias - [in]
      If the vertex has a single sector and the topology and creases cleary create two sectors,
  ...
  */
  ...
  Parameters:
    ...
    curve_callback_function - [in]
      ...
      curve_callback_function(curve_callback_context,edge_chain_count,edge_chain,nurbs_curve).
...
public:
  ...
  */
  ...
  Parameters:
    moved_vertices - the vertices to use to start the symmetry propogation
  Returns:
    True if succesful
  */
  ON_WIP_SDK
    bool UpdateSymmetry(const ON_SimpleArray<unsigned int>& moved_vertices);
  ...
  Parameters:
    ...
    motif_outer_vertex_list - [out]
      ...
      is on the outer region of the motif and it is elibable to be merged with another vertex 
  ...
  Remarks:
    ...
    symmetric under 90 and 120 degree rotations about the origin,
...
private:
  ...
  bool Internal_MakeRotateSymmetryPrimaryMotif(
    ON_Symmetry symmetry,
    ON_SubDComponentIdList& motif_outer_vertex_list
  );
  ...
  */
  ...
  Parameters:
    distance_tolerance - [in]
      Distance tolerance to use when finding vertex symmetry sets. 
      This number should be around ON_ZERO_TOLERANCE. Sloppy input subds are not handled well.
  Returns:
    True if succesful
  */
  ON_WIP_SDK
...
public:
  ...
  Parameters:
    ...
    pack_id - [in]
      If a quad pack is found, this is the id that will be assinged to each ON_SubDFace.m_pack_id
      in the quad pack.
  Returns:
