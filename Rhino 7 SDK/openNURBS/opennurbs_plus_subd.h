...
public:
  ...
  */
  ...
  Returns:
    ...
    It is not inspected or used in any part of the interpolation setup or calcuations.
  Remarks:
...
#pragma ON_PRAGMA_WARNING_DISABLE_MSC( 4251 )
  ...
  // m_solver_sp informtion needed by Solve() to calculate free vertex control net points from
