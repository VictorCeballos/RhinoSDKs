...
public:
  ...
  /*
  Description:
    Compare function for sorting ans searching 
...
static bool Internal_PackFaces_PrepareBrep(ON_Brep* brep);

static ON_SimpleArray<ON_BrepQuadFacePack> Internal_PackFaces_GetPacks(
    ON_Brep* brep, bool from_subd);

static void Internal_PackFaces_GetSurfacesAndTrims(
    ON_SimpleArray<ON_BrepQuadFacePack>& quad_packs,
    ON_SimpleArray<const ON_NurbsSurface*>& srfs,
    ON_SimpleArray<int>& del_faces,
    ON_SimpleArray<ON_ObjectArray<ON_NurbsCurve>*>& trim_curves,
    ON_SimpleArray<ON_SimpleArray<int>*>& trim_origs);

static unsigned Internal_PackFaces_AddNewFaces(
    ON_Brep* brep, ON_SimpleArray<const ON_NurbsSurface*>& srfs,
    ON_SimpleArray<ON_ObjectArray<ON_NurbsCurve>*>& trim_curves,
    ON_SimpleArray<ON_SimpleArray<int>*>& trim_origs);

static bool Internal_PackFaces_DeleteOldFaces(ON_Brep* brep,
                                              ON_SimpleArray<int>& del_faces);

static bool Internal_PackFaces_CompactTrims(ON_Brep* brep);
#endif
