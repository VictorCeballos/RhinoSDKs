...
public:
  ...
  */
  ...
  Parameters:
    ...
    domain - [in] domain of the intersection problem.
                  ...
                  domain[1] is domain of second cuve or
                  domain[1] x domain[2] is surface doamin
  ...
  */
  ...
  //    a non-montone manner from the starting point to the 
...
These are the parameters that we used to call Curve::IntersectSurface()
  ...
  surface_domain - (in)
Return :
  true if the point satisfies the first order neccessay conditions for this point being a local minimum
*/
...
public:
  ...
  */
  ...
  // set to 0.0).
  //
  // If the face is a quad and is split between vertexes 0 and 2,
  ...
  //
  // If the face is a quad and is split between vertexes 1 and 3,
