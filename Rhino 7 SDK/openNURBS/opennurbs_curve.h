...
public:
  ...
  */
  ...
  Notes:
		Here is an example of using a curve to compute the mass properies of the 
  ...
  Parameters:
    ...
    end_shape - [in]
      ...
      Explicit shapes:
        ...
        with ON::cubic_loft_ec_quadratic as the condition paramters, modify 
...
spans are combined by removing knots. SImilarly for NURBS segments of ploycurves.
