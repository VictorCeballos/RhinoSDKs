...
public:
  ...
  Parameters:
    ...
    initial_acceleration - [in]
      ...
      does not need this value.
  Remarks:
    The constructors that omit initial_velocity or initiali_acceleration
  ...
  */
  ...
  public:
    ...
    */
    ...
    // points to a N-ary force evaulation function that acts on
    // those particles.
    ...
    struct
    {
      ...
      double m_x[4];      // buffer for values to minimize need for heap managment
    } m_context;
  ...
  /*
  Description:
    Adds a Hook's law spring force bewtween particles that is proportional 
  ...
  */
  ...
  /*
  Description:
    Adds binary force bewtween particles that is proportional 
  ...
  */
  ...
  Remarks:
    To add a global "gravity", it is more efficent to use SetGlobalGravityForce().
  ...
  */  
  ...
  Description:
    Increment the current state of the particle system using 
    the semi-implicity Euler integration algorithm.
  Parameters:
    delta_time - [in]
  Remarks:
  ...
  */
  ...
  Remarks:
    ...
    almost never indepent of time.  In particular, if your system
