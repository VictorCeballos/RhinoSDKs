...
public:
  ...
  // uses it to detect when ON_PlanarSection informtion needs to 
  // be updated.
  ...
  // vector and programmers who are not familier with translating
...
public:
  ...
  */
  ...
  // bewtween adjacent curature hairs will be around 
...
public:
  ...
  // ON_SectionAnalysisAppearance.m_update_mark to efficienty
  ...
  // poor appoximation of the surface's sectional
...
/*
Description:
  Evaluate the surface to set the ps.m_points[] and ps.m_curatures[]
  values.
*/
ON_DECL
