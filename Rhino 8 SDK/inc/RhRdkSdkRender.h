...
public:
	...
	/*virtual*/ void SetGeometryEx(const RhRdk::CustomRenderMeshes::IRenderMeshes::IInstance& instance);

	virtual const ON_Mesh* Mesh(void) const;

	/*virtual*/ std::shared_ptr<const ON_Mesh> MeshEx(void) const;
	...
	/*virtual*/ std::shared_ptr<const CRhRdkMaterial> RdkMaterialEx(void) const;

	virtual void SetRdkMaterial(const CRhRdkMaterial* pRdkMaterial);
	/*virtual*/ void SetRdkMaterial(std::shared_ptr<const CRhRdkMaterial> pRdkMaterial);
