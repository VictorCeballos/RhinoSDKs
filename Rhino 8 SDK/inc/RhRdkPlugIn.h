...
public:
	...
	/*virtual*/ void AddCustomUISections(IRhRdkExpandableContentUI& ui) const; // = 0; [SDK_UNFREEZE] Currently implemented using EVF(L"AddCustomUISections, (void*)&ui")
...
public:
	...
	/*virtual*/ void RenderWindowTabsToRemove(ON_SimpleArray<ON_UUID>& a) const; // [SDK_UNFREEZE]. Implemented by EVF("RenderWindowTabsToRemove").
