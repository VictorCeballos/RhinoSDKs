...
public:
	...
	/*virtual*/ bool ReadFromRenderSettings(const ON_3dmRenderSettings& rs); // = 0; [SDK_UNFREEZE] Uses EVF(L"ReadFromRenderSettings", &rs)
	/*virtual*/ bool WriteToRenderSettings(ON_3dmRenderSettings& rs) const;  // = 0; [SDK_UNFREEZE] Uses EVF(L"WriteToRenderSettings", &rs)
...
public:
	...
	/*virtual*/ bool ReadFromRenderSettings(const ON_3dmRenderSettings& rs); // override; [SDK_UNFREEZE]
	/*virtual*/ bool WriteToRenderSettings(ON_3dmRenderSettings& rs) const;  // override; [SDK_UNFREEZE]

public:
	virtual void SetManager(class CRhRdkPostEffectManager& man) final override;

	/*virtual*/ void CopyParamsFrom(const ON_3dmRenderSettings& rs); // [SDK_UNFREEZE] Uses EVF(L"CopyParamsFrom", &rs)
	/*virtual*/ void CopyParamsTo(ON_3dmRenderSettings& rs) const;   // [SDK_UNFREEZE] Uses EVF(L"CopyParamsTo", &rs)
