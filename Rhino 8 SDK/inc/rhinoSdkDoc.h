...
public:
  ...
  */
  ...
  ON_DEPRECATED_MSG("Use Properties().RenderSettings() functions (Sun, Skylight etc.")
  const class CRhRdkDocument& RdkDocument() const;

  ON_DEPRECATED_MSG("Use Properties().RenderSettings().Sun() instead")
  const class IRhRdkSun& Sun() const;

  ON_DEPRECATED_MSG("Use Properties().RenderSettings().Skylight() instead")
  const class IRhRdkSkylight& Skylight() const;

  ON_DEPRECATED_MSG("Use Properties().RenderSettings().GroundPlane() instead")
  const class IRhRdkGroundPlane& GroundPlane() const;

  ON_DEPRECATED_MSG("Use Properties().RenderSettings().SafeFrame() instead")
  const class IRhRdkSafeFrame& SafeFrame() const;

  ON_DEPRECATED_MSG("Use Properties().RenderSettings() Render Environment functions instead")
  const class IRhRdkCurrentEnvironment& CurrentEnvironment() const;

  ON_DEPRECATED_MSG("Use Properties().RenderSettings().LinearWorkflow() instead")
  const class IRhRdkLinearWorkflow& LinearWorkflow() const;

  ON_DEPRECATED_MSG("Use Properties().RenderSettings().Dithering() instead")
  const class IRhRdkDithering& Dithering() const;

  ON_DEPRECATED_MSG("Use Properties().RenderSettings().RenderChannels() instead")
